  ...
  return (
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
          ...
          return (
            <View style={styles.slide}>
              ...
              <FastImage
                ...
                style={[
                  styles.slideImage,
                  item.key === '1' && {width: '70%', top: getResponsiveHeight(80)},
                  item.key === '2' && {width: '70%', top: getResponsiveHeight(70)},
                  item.key === '3' && {width: '70%'},
                  item.key === '4' && {width: '100%', zIndex: 999},
                ]}
                resizeMode={FastImage.resizeMode.contain}
              />
      ...
      <View style={styles.bottomContainer}>
        <TouchableOpacity activeOpacity={0.9} onPress={login}>
          <Image

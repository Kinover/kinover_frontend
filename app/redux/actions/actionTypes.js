...
export const FETCH_FAMILY_USER_LIST = "FETCH_FAMILY_USERS";
export const FETCH_MESSAGE = "FETCH_MESSAGE";
export const FETCH_RECCHALLENGE = "FETCH_RECCHALLENGE";
export const FETCH_SCHEDULE_FOR_USER_AND_DATE ="FETCH_SCHEDULE_FOR_USER_AND_DATE";
...
export const SET_FAMILY_USER_LIST='SET_FAMILY_USERS';
